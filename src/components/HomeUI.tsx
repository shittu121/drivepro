      ...
      <div className="relative z-10 flex flex-col items-center justify-center min-h-screen px-4 sm:px-6 lg:px-8">
        ...
        <div className="relative z-20 text-center max-w-4xl mx-auto">
          ...
          >
            <div className="relative">
              ...
              <motion.div
                ...
                className="absolute inset-0 bg-gradient-to-r from-blue-500 to-purple-500 rounded-2xl blur-3xl"
              />
              ...
              <div className="relative flex items-center justify-center">
                ...
                <motion.div className="flex items-baseline">
                  {['D', 'r', 'i', 'v', 'e'].map((letter, index) => (
                    <motion.span
                      ...
                      className="text-5xl sm:text-6xl lg:text-8xl font-bold text-white inline-block"
                      style={{ 
                ...
                >
                  <motion.span
                    className="text-5xl sm:text-6xl lg:text-8xl font-bold bg-gradient-to-r from-blue-400 via-purple-500 to-pink-500 bg-clip-text text-transparent inline-block"
                    style={{ 
                      fontFamily: 'system-ui, -apple-system, sans-serif',
          ...
          >
            ...
            <span className="text-blue-400 font-semibold"> Schedule lessons, track progress, and grow your business</span> effortlessly.
          </motion.p>
            ...
            <Link href="/auth/sign-up" passHref legacyBehavior>
              <a style={{ display: 'inline-block' }}>
                <motion.button
                  ...
                  whileTap={{ scale: 0.95 }}
                  className="relative group bg-gradient-to-r from-blue-600 to-purple-600 hover:from-blue-700 hover:to-purple-700 text-white text-lg sm:text-xl font-semibold py-4 px-8 sm:px-12 rounded-full transition-all duration-300 shadow-2xl w-full"
                  type="button"
                >
                  {/* Button Glow Effect */}
                  <div className="absolute inset-0 bg-gradient-to-r from-blue-600 to-purple-600 rounded-full blur-lg opacity-70 group-hover:opacity-100 transition-opacity duration-300"></div>
                  {/* Button Content */}
          ...
          >
            {['No Credit Card Required', 'Setup in Minutes', '24/7 Support'].map((feature, index) => (
              <motion.div
                ...
                className="bg-white/10 backdrop-blur-sm border border-white/20 rounded-full px-4 py-2 text-sm text-white/90"
              >
                {feature}
              </motion.div>
            ))}
        ...
        <motion.div
          ...
          className="absolute top-20 left-10 w-8 h-8 bg-blue-500/30 rounded-full blur-sm"
        />
        <motion.div
          animate={{ 
            y: [0, 15, 0],
        ...
        <motion.div
          ...
          className="absolute bottom-40 left-20 w-4 h-4 bg-pink-500/30 rounded-full blur-sm"
        />
      </div>
    </div>
  );
