  ...
  return (
    <div className="h-svh">
      <div className="h-svh uppercase items-center w-full absolute z-60 pointer-events-none px-10 flex justify-center flex-col">
        ...
        <button
          className="explore-btn px-8 py-4 mt-10 rounded-2xl bg-white/10 border border-white/30 backdrop-blur-md text-white text-lg font-semibold shadow-lg hover:bg-white/20 transition-all duration-200 flex items-center gap-2 focus:outline-none focus:ring-2 focus:ring-white/60"
