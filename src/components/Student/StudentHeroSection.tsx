...
const HeroSection = React.forwardRef<HTMLDivElement, HeroSectionProps>(
  (
    {
      className,
      title = "Welcome to DriverPro",
      subtitle = {
        regular: "Accelerate your learning with ",
        gradient: "a complete driving school solution.",
      },
    ...
    return (
      <div className={cn("relative", className)} ref={ref} {...props}>
        ...
        <section className="relative max-w-full h-full mx-auto z-1">
          ...
          <div className="max-w-screen-xl z-10 mx-auto px-4 py-16 sm:py-28 gap-12 md:px-8 min-h-screen">
            <div className="text-center mb-0 lg:mb-8 md:mb-8 mt-12 md:mt-0 lg:mt-0">
            ...
            <div className="flex items-center justify-center min-h-[calc(100vh-200px)] sm:min-h-0">
              <div className="space-y-5 max-w-3xl leading-0 lg:leading-5 mx-auto text-center">
                ...
                <p className="max-w-2xl mx-auto text-gray-600 dark:text-gray-300 text-sm sm:text-base md:text-lg">
                  {description}
                </p>
